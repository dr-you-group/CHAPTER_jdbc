-- Customized large-DB-friendly version for chapter_inpatientvisit.sql
-- Semantics preserved:
--   1) visit concept 262, 9201, 9203 + descendants
...
WITH visit_codes AS (
  ...
  WHERE c.concept_id IN (262, 9201, 9203)
  ...
  WHERE ca.ancestor_concept_id IN (262, 9201, 9203)
